                ...
                <Flex flexDir="column" w={["100%", "100%", "50%"]} mr={[0, 0, 4]}>
                    ...
                    >
                        <Text
                            ...
                            mb={6}
                        >
                            An <strong>electrical engineer 👨‍💻</strong>, <strong>procastinator 📹</strong>, and <strong>student 👨‍🎓</strong> living and working in Toronto. You've stumbled onto my online portfolio, resume, blog, and all things in between.
                        </Text>
                    </motion.div>
                    <motion.div
                        initial={{ y: -20, opacity: 0 }}
                    ...
                    >
                        <Flex flexDir={["column", "row", "row"]}>
                            <Link href=" " _hover={{ textDecor: 'none' }} w={["100%", "100%", null]} mr={[0, 2, 2]} mb={[2, 0, 0]} isExternal>
                                <Button
                                    w={["100%", "100%", null]}
                                    colorScheme="red"
                                    size="md"
                            ...
                            <Link href="https://github.com/sponsors/giabaocorn20" _hover={{ textDecor: 'none' }} w={["100%", "100%", null]} isExternal>
                                <Button
                                    w={["100%", "100%", null]}
                                    colorScheme="gray"
                                    variant="outline"
                ...
                <Box mt={[10, 10, 0]} w={["100%", "100%", "50%"]}>
                    ...
                    >
                        <AspectRatio ratio={16 / 9}>
                            <iframe src="https://www.youtube.com/embed/kEXn_fNBBzM" alt="Featured YouTube video" allowFullScreen={true} style={{ borderRadius: 10 }} />
                        </AspectRatio>
                    </motion.div>
                </Box>
            </Flex>
