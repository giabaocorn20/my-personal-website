...
| ------ | ---- | --------- | --------- | ------- | ---------- | -------- |
| Greeting | Hi, Hi there, Hola, Hello, Hello there, Hya, ... | Hi human, please tell me your GeniSys user, H... | {'function': '', 'entities': False, 'responses... | {'in': '', 'out': 'GreetingUserRequest', 'clea... | NA | \[\] |
| GreetingResponse | My user is Adam, This is Adam, I am Adam, It ... | Great! Hi &lt;HUMAN&gt;! How can I help?, Good! Hi ... | {'function': 'extensions.gHumans.updateHuman',... | {'in': 'GreetingUserRequest', 'out': '', 'clea... | NA | \[{'entity': 'HUMAN', 'rangeFrom': 3, 'rangeTo'... |
| CourtesyGreeting | How are you?, Hi how are you?, Hello how are ... | Hello, I am great, how are you? Please tell m... | {'function': '', 'entities': False, 'responses... | {'in': '', 'out': 'CourtesyGreetingUserRequest... | NA | \[\] |
| CourtesyGreetingResponse | Good thanks! My user is Adam, Good thanks! Th... | Great! Hi &lt;HUMAN&gt;! How can I help?, Good! Hi ... | {'function': 'extensions.gHumans.updateHuman',... | {'in': 'GreetingUserRequest', 'out': '', 'clea... | NA | \[{'entity': 'HUMAN', 'rangeFrom': 5, 'rangeTo'... |
| CurrentHumanQuery | What is my name?, What do you call me?, Who d... | You are &lt;HUMAN&gt;! How can I help?, Your name i... | {'function': 'extensions.gHumans.getCurrentHum... | {'in': '', 'out': 'CurrentHumanQuery', 'clear'... | NA | \[\] |
